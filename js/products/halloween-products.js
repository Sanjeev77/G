...
// - Last Updated: 10/31/2025, 12:45:15 PM
//
...
const customCategoryConfig = {
    ...
    "seoTitle": "",
    "seoDescription": "",
    "lastUpdated": "2025-10-31T07:15:13.930Z"
};

// Make available globally for category pages and product rotation
if (typeof window !== 'undefined') {
    window.halloweenSpecialOffers = specialOffersData;  // For halloween-gifts page
    window.specialOffersData = specialOffersData;       // For special-offers page and product rotation
    window.customCategoryConfig = customCategoryConfig; // For SEO
}

// Export for module systems
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { specialOffersData, customCategoryConfig };
}
